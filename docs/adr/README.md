...
1. Скопируйте [TEMPLATE.md](/home/strider/projects/knowledge-db/docs/adr/TEMPLATE.md).
...
|---|---|---|---|---|---|
| [0001](/home/strider/projects/knowledge-db/docs/adr/0001-offline-first-git-first.md) | Offline-first + Git-first как базовый принцип | accepted | 2026-03-06-initial-project-scaffold | - | - |
| [0002](/home/strider/projects/knowledge-db/docs/adr/0002-knowledge-node-storage-format.md) | Формат хранения knowledge nodes (Obsidian-compatible) | accepted | 2026-03-06-obsidian-compatible-storage | - | - |
| [0003](/home/strider/projects/knowledge-db/docs/adr/0003-kb-server-monolith.md) | Монолит `kb-server` (API + UI + Telegram + MCP) | accepted | 2026-03-06-initial-project-scaffold | - | - |
| [0004](/home/strider/projects/knowledge-db/docs/adr/0004-ingestion-pipeline-llm-orchestration.md) | Ingestion pipeline с LLM orchestration и fetch-chain | accepted | 2026-03-07-implement-ingestion-pipeline, 2026-03-10-ingest-via-ui | - | - |
| [0005](/home/strider/projects/knowledge-db/docs/adr/0005-rag-embedding-hybrid-architecture.md) | RAG/embedding архитектура (SQLite index + hybrid retrieval) | accepted | 2026-05-02-add-rag-semantic-search, 2026-05-04-add-hybrid-search-rag-ui | - | - |
| [0006](/home/strider/projects/knowledge-db/docs/adr/0006-split-sqlite-index-and-chat.md) | Разделение SQLite: `index.db` и `chat.db` | accepted | 2026-05-02-add-rag-semantic-search, 2026-05-12-chat-memory-and-history | - | - |
| [0007](/home/strider/projects/knowledge-db/docs/adr/0007-chat-session-memory-temporary-storage.md) | Chat sessions/memory как временное SQLite-хранилище | accepted | 2026-05-12-chat-memory-and-history | - | - |
