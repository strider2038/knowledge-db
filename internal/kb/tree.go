...
// GetNodeByID читает узел по стабильному frontmatter id.
func GetNodeByID(ctx context.Context, basePath, nodeID string) (*Node, error) {
	return NewStore(afero.NewOsFs()).GetNodeByID(ctx, basePath, nodeID)
}
