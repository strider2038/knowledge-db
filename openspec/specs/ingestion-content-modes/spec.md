...
Операционная ось content mode для ingestion: как получать и преобразовывать тело узла отдельно от storage form (`type`, `content_profile`). См. ADR 0011 и `docs/concepts/ingestion-workflows.md`.
